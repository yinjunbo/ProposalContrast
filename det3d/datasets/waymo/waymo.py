...
class WaymoDataset(PointCloudDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(WaymoDataset, self).__init__(
            root_path, info_path, ssl_mode=ssl_mode, pipeline=pipeline, test_mode=test_mode, class_names=class_names
        )
    ...
    def load_infos(self, info_path):
        ...
        if isinstance(_waymo_infos_all[0], list):
            _waymo_infos_all = [ele[0] for ele in  _waymo_infos_all]
    ...
    def get_sensor_data(self, idx):
        ...
        res = {
            ...
            "metadata": {
                ...
                "token": info["token"],
                "pcdet_token": info["pcdet_token"] if "pcdet_token" in info else None
            },
            "calib": None,
            "cam": {},
        ...
        if data is None:
            idx = np.random.permutation(range(len(self._waymo_infos)))[idx]
            print("Correspondence less than 2048! Re-sampling ...")
