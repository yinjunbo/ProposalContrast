...
# align with OpenPCDet training samples
train_anno = data_root+"/infos_pcdet_train_01sweeps_filter_zero_gt.pkl"
...
# yapf:enable
# runtime settings
total_epochs = 30   # align with OpenPCDet learning epochs
device_ids = range(8)
